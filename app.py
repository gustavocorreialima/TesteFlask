...
def preencher_pptx(template_path, dados):
    """Função adaptada para retornar em memória"""
...
def gerar_pptx():
    try:
        ...
        # Processa o PPTX e retorna em memória
        output = preencher_pptx(TEMPLATE_PATH, dados_json)
